...
### Cascade System
Sequential scene generation. Define setting, placement, actions, emotion, and state for each scene — add, remove, or reorder characters per beat, pick who interacts with whom, and toggle AI vs manual placement per beat. Once your story is made, use the Cast button to return to the main editor, add your characters, and watch them play out the scenes. Includes unsaved-changes detection with save/discard confirmation.
